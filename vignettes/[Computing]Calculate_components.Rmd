...
here::i_am("vignettes/[Computing]Calculate_components.Rmd")
...
if(!exists("france_metro")){
  if(!file.exists(here::here("raw_data","2020_France_metro_WGS84.geojson"))){
    URLfr <- "https://github.com/Universite-Gustave-Eiffel/lasso-data-analysis/raw/main/raw_data/2020_France_metro_WGS84.geojson"
    download.file(url = URLfr, destfile = here::here("raw_data","2020_France_metro_WGS84_2.geojson"))
    france_metro2 <- sf::st_read(here::here("raw_data","2020_France_metro_WGS84_2.geojson"))
  }
  else{
  france_metro <- sf::st_read(here::here("raw_data","2020_France_metro_WGS84.geojson"))
  }
}
```

...
```{r, file=here::'../R/database-connection.R', include=FALSE}
source(here::here("R/database-connection.R"))
```
...
filtered_track_info <- sf::st_read(con, query = query) %>% head(100)
...
sfc_as_cols <- function(x, names = c("lon","lat")) {
  # source: https://github.com/r-spatial/sf/issues/231#issuecomment-282359896
...
coord_points <- sfc_as_cols(track_points)  %>% sf::st_drop_geometry()
```

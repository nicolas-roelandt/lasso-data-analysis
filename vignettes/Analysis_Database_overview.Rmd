...
The views are created on the PostgreSQL database by the following SQL scripts : 

- [track_countries.sql](https://github.com/Universite-Gustave-Eiffel/lasso-data-analysis/blob/main/scripts/track_countries.sql)
- [unique_track_tags.sql](https://github.com/Universite-Gustave-Eiffel/lasso-data-analysis/blob/main/scripts/unique_track_tags.sql)
- 
...
df_test <- dplyr::inner_join(count_tags, count_tracks)
